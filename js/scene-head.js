...
splineLoader.load(
  "https://prod.spline.design/MKCm6J5TbMuSfc3v/scene.splinecode",
  (spline) => {
    obj = spline.children[1];
    spline.ambientLight.intensity = 1;
    scene.add(spline);
    obj.position.y = 40;
    tl.fromTo(
      obj.scale,
...
//Light
const light = new THREE.PointLight(0xffffff, 6, 1500);
...
const cameraPosition = {
  x: 381.23258009415105,
  y: 59.85333457675216,
  z: -21.392235123813848,
};
...
//Renderer
const canvas = document.querySelector(".card-head");
